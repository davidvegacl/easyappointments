...
$lang['about_app_info'] = 'Agendastic es un aplicativo web completamente personalizable que le permitirá a sus clientes agendar citas con Usted a través internet. Además, le permitirá sincronizar sus datos con Google Calendar, para poder utilizarlos con otros servicios.';
...
$lang['api_token_hint'] = 'Defina un token secreto para habilitar la autentificación por token mediante la API de Agendastic.';
